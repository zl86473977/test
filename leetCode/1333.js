...
var filterRestaurants = function(restaurants, veganFriendly, maxPrice, maxDistance) {
	...
	// 	if ((veganFriendly === 1 && restaurants[i][2] === 0) || // 是素食主义，餐厅是荤素搭配则筛掉此条
	// 		restaurants[i][3] > maxPrice || // 太贵
	// 		restaurants[i][4] > maxDistance // 太远
	// 	) {
	// 		continue
	// 	} else {
	...
	// }
	// 方法二
	const temp = restaurants.filter(item => item[3] <= maxPrice && item[4] <= maxDistance && !(veganFriendly && !item[2]));
